...
def _stateful_trainer_step(
    ...
    optimizer_def: optax.GradientTransformation | optax.GradientTransformationExtraArgs,
    kwargs: dict[str, Any],
...
class StatefulTrainer(pz.Struct):
  ...
  def step(self, optimizer_extra_args: dict[str, Any] | None = None, **kwargs) -> AuxOutPyTree:
    ...
    aux_out, new_params, new_state_vars, new_internal_state = self.step_fn(
        ...
        kwargs=kwargs,
        optimizer_extra_args=optimizer_extra_args,
    )
